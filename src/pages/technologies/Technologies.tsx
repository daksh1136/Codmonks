            ...
            <section className="py-20 px-4 relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto text-center text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to="/contact" className="bg-custom-gradient text-white hover:bg-blue-50 font-semibold rounded-lg px-8 py-3">
                            Start Your Project
                        </Link>
                        <Link to="/portfolio" className="bg-white border-white rounded-lg text-purple-600 hover:bg-white font-semibold px-8 py-3">
                            View Our Work
                        </Link>
                    </div>
                </div>
